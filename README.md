...
Check the "Transfer" event in the contract of BoredApeYachtClub (BAYC)

- Contract Address: 0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D

1. Open the contract on [Etherscan](https://etherscan.io/address/0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d#code#L1746)
2. Click on the tab "Events"
3. Now click on the filter "Method", and select "Safe Transfer From"
   What you see now are all transction of transfer of a ERC-721, BAYC Token
4. Click on the transaction hash
5. Click on Logs
   Here you can see a "Transfer" event associated with thatt specific transaction
